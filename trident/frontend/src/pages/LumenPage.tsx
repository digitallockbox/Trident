...
import { useLumen } from '../state/hooks/useLumen';

const LumenPage: FC = () => {
  const { data, loading, execute } = useLumen();

  return (
    <div className="container mx-auto px-4 py-12">
      <GradientTitle text="Lumen Engine" size="lg" />
      <p className="text-slate-300 mt-4 mb-8">Clarity and transparency.</p>
      <GlassCard title="Lumen Status">
